    ...
    <flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
        ...
        <flux:navlist variant="outline">
            <flux:navlist.group :heading="__('Platform')" class="grid">
                ...
                @can('access-team-manager-dashboard')
                    <flux:navlist.item icon="user-group" :href="route('team-manager.dashboard')"
                ...
                @can('access-statistician-dashboard')
                    <flux:navlist.item icon="chart-bar-square" :href="route('statistician.dashboard')"
                        :current="request()->routeIs('statistician.*')" wire:navigate>
                        {{ __('Statistician Dashboard') }}
                    </flux:navlist.item>
